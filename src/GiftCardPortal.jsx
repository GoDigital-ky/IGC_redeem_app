...
export default function GiftCardPortal({ user }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-blue-100 to-blue-200 px-4">
      <div className="w-full max-w-sm bg-white p-6 rounded shadow text-center sm:max-w-md sm:p-8">
